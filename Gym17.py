...
app.config['MYSQL_PASSWORD'] = 'CompactDiscs'
...
def addMember():
    ...
    if request.method == 'POST' and form.validate():
        ...
        # Call the stored procedure AddMember with the prof parameter
        cur.callproc('AddMember', (username, password, name, street, city, phone, plan, trainor))
        mysql.connection.commit()
        cur.close()
